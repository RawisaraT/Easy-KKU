...
public class SignUpActivity extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameString.equals("") || phoneString.equals("") ||
                    ...
                    //Non Choose Image
                    MyAlert myAlert = new MyAlert(SignUpActivity.this, R.drawable.nobita48, "ยังไม่เลือกรูป", "กรุณาเลือกรูปด้วยค่ะ");
                    myAlert.myDialog();
                } else {
                    //Choose Image OK
                    upLoadImageToServer();
    ...
    private class AddNewUser extends AsyncTask<String, Void, String> {
        ...
        } //doInBack ต่อเน็ต ต่อไม่ได้ก็พยายามต่อ (ทำงานเบื้องหลัง)
